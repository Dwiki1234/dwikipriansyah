...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Sep 2022 pada 15.37
...
--
ALTER TABLE `transaksi`
  ADD CONSTRAINT `transaksi_ibfk_2` FOREIGN KEY (`id_pembeli`) REFERENCES `pembelian` (`id_pembeli`) ON DELETE CASCADE ON UPDATE CASCADE,
